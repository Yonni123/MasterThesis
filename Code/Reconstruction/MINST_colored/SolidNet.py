...
from colored_MNIST_generator import generate_data, generate_solid_data
...
for bn in bottlenecks:  # Train SolidNet
    try:
        SolidNet = load_model(f'SolidNet_cnn/SolidNet_{bn}.h5')
...
for bn in bottlenecks:  # Train SolidNet
    try:
        SolidNet = load_model(f'SolidNet_mlp/SolidNet_{bn}.h5')
